...
public class ParquetOutputEnhancedDialog extends BaseTransformDialog implements ITransformDialog {

  public static final Class<?> PKG = ParquetOutputEnhancedMeta.class;

  protected ParquetOutputEnhancedMeta input;
  ...
  public ParquetOutputEnhancedDialog(
      Shell parent,
    ...
    input = (ParquetOutputEnhancedMeta) in;
  }
