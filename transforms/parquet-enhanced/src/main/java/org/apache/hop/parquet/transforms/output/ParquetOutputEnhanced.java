...
public class ParquetOutputEnhanced
  ...
  public ParquetOutputEnhanced(
      ...
      ParquetOutputEnhancedMeta meta,
      ParquetOutputEnhancedData data,
      int copyNr,
  ...
  public boolean processRow() throws HopException {
    ...
    try {
      ...
      // Clone Rows and convert Date & Timestamps to Long
      ...
      data.writers.get(data.currentFilename).write(new RowMetaAndData(parquetRowMeta, parquetRow));
